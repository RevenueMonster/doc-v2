...
:::note
Get All Payment Transactions will only pass **50 transactions**

**Fetch More transaction : `https://sb-open.revenuemonster.my/v3/payment/transactions?cursor={response cursor}`**
:::
...
| --------- | ------ | --------------------------------------------------------------------------------------------------------- | ---------------------------- |
| `items`   | Array  | Transaction array of object                                                                               | (Refer to explanation below) |
