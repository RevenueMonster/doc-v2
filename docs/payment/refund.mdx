...
:::note
Refund is to get funds returned to customer before settlement. <br/>(Before money is settled to merchant.)
:::
...
| Parameter      | Type   | Required | Description                                                             | Example |
| -------------- | ------ | -------- | ----------------------------------------------------------------------- | ------- |
| `type`         | String | Yes      | Fully or partial refund. "FULL" (**currenty only support FULL refund**) | "FULL"  |
