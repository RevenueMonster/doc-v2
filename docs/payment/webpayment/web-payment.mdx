...
| `method`        | []String | Yes      | [RM currently supported method](../.././method#web-payment--mobile-payement--mobile-web-payment)        | ["WECHATPAY_MY","WECHATPAY_CN" <br/>,"PRESTO_MY","BOOST_MY","TNG_MY" , "ALIPAY_CN","GRABPAY_MY","RAZER_MY", GOBIZ_MY] |
...
### Create a unified payment checkout

After you get the **url** from **response API**, you can append a query String<br/>
:::note
