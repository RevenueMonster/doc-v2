...
Url : `https://sb-open.revenuemonster.my/v3/payment/transaction/qrcode/5413b4583a9440dd351b2dde0c0ea166`

:::note
To get specific QR Code generated previously in the system, by passing in code in your query (/qrcode/...).
:::
