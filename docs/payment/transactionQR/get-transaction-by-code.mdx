...
Url : `https://sb-open.revenuemonster.my/v3/payment/transaction/qrcode/5413b4583a9440dd351b2dde0c0ea166/transactions`

:::note
To get all transactions under existing QR code, by passing in code in your query (/qrcode/.../transactions).
:::

### Request Parameters

:::note
No request parameter is required for this endpoint\_
:::
