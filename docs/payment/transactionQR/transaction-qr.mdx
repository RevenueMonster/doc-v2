...
Get the QR Code URL <b>qrCodeUrl</b> from repsond endpoint <br />
...
### Step 4 : User will received a payment status notification
...
After payment done user will redirect to a Url link that set at <b>redirectUrl</b>.

### Step 6 : Payment History

User can view they transaction history in they own wallet application

### Step 7 : Merchant can view their transaction record in Merchant Portal
...
| `method`          | []String | No       | [RM currently supported method](../.././method/transaction-qr)                                                                     | ["WECHATPAY","WECHATPAY_MY", <br/> "WECHATPAY_CN","PRESTO_MY",<br/>"BOOST_MY",<br/>"ALIPAY_CN" ] |
...
| `method`          | []String | [RM currently supported method](../.././method/transaction-qr)                         | ["WECHATPAY","WECHATPAY_MY", <br/> "WECHATPAY_CN","PRESTO_MY",<br/>"BOOST_MY",<br/>"ALIPAY_CN"] |
...
If you don't received any repsond please ingestion
