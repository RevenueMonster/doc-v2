...
URL : `https://open.revenuemonster.my/v3/partner/merchant/{merchantID}/review`<br/>
Sandbox URL : `https://sb-open.revenuemonster.my/v3/partner/merchant/{merchantID}/review`
...
```json
curl --location --request POST "https://sb-open.revenuemonster.my/v3/partner/merchant/1629292083526787883/review" \
