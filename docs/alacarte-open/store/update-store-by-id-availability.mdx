...
URL: `https://api.alacarte.my/open/v1/store/{id}/availability`<br/>

Sandbox URL: `https://sb-api.alacarte.my/open/v1/store/{id}/availability`
...
```json
curl --location --request PATCH 'https://sb-api.alacarte.my/open/v1' \
...
--header 'X-Signature: ' \
--data-raw '{
