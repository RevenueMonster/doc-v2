...
URL: `https://api.alacarte.my/open/v1/store/{id}/delivery`<br/>

Sandbox URL: `https://sb-api.alacarte.my/open/v1/store/{id}/delivery`
...
```json
curl --location --request PATCH 'https://sb-api.alacarte.my/open/v1/store/{id}/delivery' \
...
--header 'X-Signature: ' \
--data-raw '{
    "methods": ["OWN"],
    "cost": [
      {
  ...
  "item": {
    ...
    "delivery": {
      ...
      "waiver": [
        ...
        {
          "type": "FIXED",
          "minimumSpentAmount": 500,
          "amount": 100
        }
      ]
    },
    "updatedAt": "2024-07-22T04:47:50.586847Z"
  }
}
```
