...
URL: `https://api.alacarte.my/open/v1/store/{id}`<br/>

Sandbox URL: `https://sb-api.alacarte.my/open/v1/store/{id}`

:::note

- Using `id` to get your store detail.
...
| --------- | ----- | ----------------------------------- | --------------------- |
| `id`      | Param | ID of the Store that Create from RM | "2808912573238362402" |

> Example Request

```json
curl --location --request GET 'https://sb-api.alacarte.my/open/v1/store/{id}' \
