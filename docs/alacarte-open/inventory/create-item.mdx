...
URL: `https://api.alacarte.my/open/v1/item`<br/>

Sandbox URL: `https://sb-api.alacarte.my/open/v1/item`
...
| `categoryId`  | String | ID of the Category                        | "5ec1bf480e7df1ca6f3f6350"                               |
| `sku`         | String | Item SKU                                  | "fkj31i"                                                 |
| `taxCode`     | String | Item taxCode                              | "SR8" or "SR6" or "ZRE" or "ZRL"                         |
...
```json
curl --location --request POST 'https://sb-api.alacarte.my/open/v1/item' \
...
--data-raw '{
    ...
    "sku": "fkj31i",
    "categoryId": "5ec1bf480e7df1ca6f3f6350"
}'
```
