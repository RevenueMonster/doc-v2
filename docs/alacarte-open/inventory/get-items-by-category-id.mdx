...
URL: `https://api.alacarte.my/open/v1/category/{id}/items`<br/>

Sandbox URL: `https://sb-api.alacarte.my/open/v1/category/{id}/items`

:::note

- Using `category id` to get items
...
```json
curl --location --request GET 'https://sb-api.alacarte.my/open/v1/category/{id}/items' \
