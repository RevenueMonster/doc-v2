...
- Using `storeId` to update category
...
| `status`         | String | Status of Category                  | "ACTIVE"                   |
| `positionChange` | Uint   | Change current position at Category | 1                          |
