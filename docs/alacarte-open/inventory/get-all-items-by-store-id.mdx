...
URL: `https://api.alacarte.my/open/v1/store/{id}/items`<br/>

Sandbox URL: `https://sb-api.alacarte.my/open/v1/store/{id}/items`

:::note

- Using `Store Id` to get all items
...
```json
curl --location --request POST 'https://sb-api.alacarte.my/open/v1/store/{id}/items' \
