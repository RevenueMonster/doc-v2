...
URL: `https://api.alacarte.my/open/v1/store/{storeId}/order/{id}`<br/>

Sandbox URL: `https://sb-api.alacarte.my/open/v1/store/{storeId}/order/{id}`

:::note

- Using storeId and Order id to get Order.
...
```json
curl --location --request GET 'https://sb-api.alacarte.my/open/v1/store/{storeId}/order/{id}' \
