...
title: Alipay Mini Program Payment
sidebar_label: Alipay Mini Program Payment
---
...
| ------------ | ------ | ------------------------------------------------------------------------------------------------------- | --------------------- |
| `checkoutId` | String | refer to [web-payment](././payment/webpayment/web-payment#response-parameters) to get your `checkoutId` | "1607935374438928096" |
| `method`     | String | [RM currently supported method](././method/web-payment)                                                 | "ALIPAY_CN"           |
