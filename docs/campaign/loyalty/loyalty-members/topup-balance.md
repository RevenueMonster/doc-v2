...
id: topup-balance
title: Topup Balance
sidebar_label: Topup Balance
---

import { Box, Heading, Text, Card, Image, Button, Flex } from "rebass";

**Method :** <span style={{ color: "orange", fontWeight: "bold" }}>POST</span><br/>
URL : `https://open.revenuemonster.my/v3/loyalty/member/:memberId/topup-balance`<br/>
Sandbox URL : `https://sb-open.revenuemonster.my/v3/loyalty/member/:memberId/topup-balance`
...
```json
curl --location --request GET "{{open_base_path}}/v3/loyalty/member/:memberId/topup-balance" \
